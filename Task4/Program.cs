...
namespace Task4
{
    ...
    public class SavingsAccount : Account
    {
        ...
        public SavingsAccount(string name = "Unnamed Account", double balance = 0.0, double interestRate = 3.0)
            : base(name, balance)
        {
    ...
    public class TrustAccount : SavingsAccount
    {
        ...
        public TrustAccount(string name = "Unnamed Account", double balance = 0.0, double interestRate = 3.0)
